    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Alert when Claude Code or Codex running in a terminal needs your input or finishes. Desktop notification when Xterax is unfocused, in-app otherwise."
        >
          <Switch
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open Xterax automatically when you sign in."
          >
            <Switch
              checked={autostart}
