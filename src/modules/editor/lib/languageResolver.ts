...
function buildRainbowCsvExtension(sep: string): Extension {
  ...
  const theme = EditorView.baseTheme({
    ...
    "&dark .csv-col-0, .dark &.csv-col-0, :is(.dark *) .csv-col-0": {
      color: "oklch(0.80 0.17 25)",
    },
    "&dark .csv-col-1, .dark &.csv-col-1, :is(.dark *) .csv-col-1": {
      color: "oklch(0.82 0.15 55)",
    },
    "&dark .csv-col-2, .dark &.csv-col-2, :is(.dark *) .csv-col-2": {
      color: "oklch(0.80 0.17 145)",
    },
    "&dark .csv-col-3, .dark &.csv-col-3, :is(.dark *) .csv-col-3": {
      color: "oklch(0.82 0.16 240)",
    },
    "&dark .csv-col-4, .dark &.csv-col-4, :is(.dark *) .csv-col-4": {
      color: "oklch(0.80 0.18 305)",
    },
    "&dark .csv-col-5, .dark &.csv-col-5, :is(.dark *) .csv-col-5": {
      color: "oklch(0.82 0.15 185)",
    },
    "&dark .csv-col-6, .dark &.csv-col-6, :is(.dark *) .csv-col-6": {
      color: "oklch(0.80 0.17 340)",
    },
    "&dark .csv-col-7, .dark &.csv-col-7, :is(.dark *) .csv-col-7": {
      color: "oklch(0.82 0.14 95)",
    },
    "&dark .csv-col-8, .dark &.csv-col-8, :is(.dark *) .csv-col-8": {
      color: "oklch(0.80 0.16 195)",
    },
    "&dark .csv-col-9, .dark &.csv-col-9, :is(.dark *) .csv-col-9": {
