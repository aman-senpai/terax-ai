...
export const DEFAULT_THEME_ID = "xterax-default";
...
export async function setPermissions(value: PermissionSettings): Promise<void> {
...
const KEYS_CHANGED_EVENT = "xterax://ai-keys-changed";
