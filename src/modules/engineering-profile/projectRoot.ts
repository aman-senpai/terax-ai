 ...
 *  - .terax/ at the *git root* of the project (not a random subdir).
 *  - Stable across cd inside one repo.
 *  - Switches automatically when the active terminal/context moves to a
 *    different top-level checkout (e.g. resume vs terax-ai).
 *
 ...
 * (where .terax/ lives, where signals/profiles are stored) given a live
 * context directory.
 *
