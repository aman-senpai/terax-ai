...
const AGENT_EVENT: &str = "xterax:agent-signal";
...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[xterax: dropped output due to backpressure]\x1b[0m\r\n";
